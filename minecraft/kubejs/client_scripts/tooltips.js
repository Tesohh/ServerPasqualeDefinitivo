ItemEvents.tooltip(event => {
	event.add("andesite_machine_hull", "The inner guts of all basic andesite machines")
	event.add("logistics_machine_hull", "The inner guts of high logistics machines")
